...
/* Pointers to input/output buffers. libGAP users must not access these
 * buffers
 * directly! */
...
/* stderr is captured in a static buffer to make it easier to pass it around
