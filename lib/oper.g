...
##  <Ref Var="OPER_FLAGS"/> is a record that stores additional information
...
##  information.
##
##  More precisely, for the operation <C>op</C>, which has been declared by
##  by several calls of <C>DeclareOperation</C>, each with second arguments
##  <A>req1</A>, <A>req2</A>, \ldots, then calling <Ref Func="GET_OPER_FLAGS"/>
##  with argument <A>op</A> returns the list <C>[ flags1, flags2, \ldots ]</C>,
##  where <C>flagsi</C> is the list of flags of the filters in <C>reqi</C>.
##
##  Calling <Ref Func="GET_DECLARATION_LOCATIONS"/> with argument <A>op</A>
##  returns a list of source locations where <Ref Func="DeclareOperation"/>
##  was called.
##
##  A <E>source location</E> is a pair <C>[ f, n ]</C> where <C>f</C> is a filename and
##  <C>l</C> is a line number in the file.
##  </Description>
##  </ManSection>
##
