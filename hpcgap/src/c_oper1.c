 ...
 Obj  a_mutflag )
{
 ...
 if ( t_1 ) {
  ...
  if ( t_1 ) {
   ...
   SET_STARTLINE_BODY(t_7, INTOBJ_INT(603));
   SET_ENDLINE_BODY(t_7, INTOBJ_INT(621));
 ...
 Obj  a_keytest )
{
 ...
 if ( t_1 ) {
  ...
  SET_STARTLINE_BODY(t_2, INTOBJ_INT(758));
  SET_ENDLINE_BODY(t_2, INTOBJ_INT(762));
 ...
 ENVI_FUNC( t_6 ) = TLS(CurrLVars);
 t_7 = NewBag( T_BODY, NUMBER_HEADER_ITEMS_BODY*sizeof(Obj) );
 SET_STARTLINE_BODY(t_7, INTOBJ_INT(779));
 SET_ENDLINE_BODY(t_7, INTOBJ_INT(779));
 SET_FILENAME_BODY(t_7, FileName);
 BODY_FUNC(t_6) = t_7;
 CHANGED_BAG( TLS(CurrLVars) );
 ...
 SET_ENDLINE_BODY(t_7, INTOBJ_INT(816));
 SET_FILENAME_BODY(t_7, FileName);
 BODY_FUNC(t_6) = t_7;
 CHANGED_BAG( TLS(CurrLVars) );
 CALL_6ARGS( t_1, t_2, t_3, t_4, t_5, INTOBJ_INT(0), t_6 );
 ...
 Obj  a_arg )
{
 ...
 SET_STARTLINE_BODY(t_5, INTOBJ_INT(884));
 SET_ENDLINE_BODY(t_5, INTOBJ_INT(900));
 ...
 Obj  self )
{
 ...
 SET_ENDLINE_BODY(t_4, INTOBJ_INT(545));
 SET_FILENAME_BODY(t_4, FileName);
 BODY_FUNC(t_3) = t_4;
 CHANGED_BAG( TLS(CurrLVars) );
 CALL_2ARGS( t_1, t_2, t_3 );
 ...
 SET_STARTLINE_BODY(t_3, INTOBJ_INT(564));
 ...
 ENVI_FUNC( t_2 ) = TLS(CurrLVars);
 t_3 = NewBag( T_BODY, NUMBER_HEADER_ITEMS_BODY*sizeof(Obj) );
 SET_STARTLINE_BODY(t_3, INTOBJ_INT(628));
 SET_ENDLINE_BODY(t_3, INTOBJ_INT(634));
 SET_FILENAME_BODY(t_3, FileName);
 BODY_FUNC(t_2) = t_3;
 CHANGED_BAG( TLS(CurrLVars) );
 CALL_1ARGS( t_1, t_2 );
 ...
 ENVI_FUNC( t_3 ) = TLS(CurrLVars);
 t_4 = NewBag( T_BODY, NUMBER_HEADER_ITEMS_BODY*sizeof(Obj) );
 SET_STARTLINE_BODY(t_4, INTOBJ_INT(754));
 ...
 ENVI_FUNC( t_3 ) = TLS(CurrLVars);
 t_4 = NewBag( T_BODY, NUMBER_HEADER_ITEMS_BODY*sizeof(Obj) );
 SET_STARTLINE_BODY(t_4, INTOBJ_INT(852));
 SET_ENDLINE_BODY(t_4, INTOBJ_INT(901));
 SET_FILENAME_BODY(t_4, FileName);
 BODY_FUNC(t_3) = t_4;
 CHANGED_BAG( TLS(CurrLVars) );
 CALL_2ARGS( t_1, t_2, t_3 );
